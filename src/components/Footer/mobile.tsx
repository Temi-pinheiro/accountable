      ...
      <Group key='links'>
        <div className='flex flex-col gap-y-6 w-full'>
          ...
          >
            ...
            <li>
              <Link href='/lender-agreement'>Lender Agreement</Link>
            </li>
            <li>
              <Link href='/borrower-agreement'>Borrower Agreement</Link>
            </li>
            <li>
              <Link href='/guarantor-agreement'>Guarantor’s Agreement</Link>
            </li>
          </FooterAccordion>
          <FooterAccordion
            key='comapany'
          ...
          >
            ...
            <li>
              <Link href='/business'>P2vest for Business</Link>
            </li>
          </FooterAccordion>
          <FooterAccordion
            key='Personal'
          ...
          >
            ...
            <li>
              <Link href='/bnpl'>BNPL</Link>
            </li>
            <li>
              <Link href='/parasol-insurance'>Parasol</Link>
            </li>
            <li>
              <Link href='/bail-me'>Bail Me</Link>
            </li>
          </FooterAccordion>
          <FooterAccordion
            key='Contact Us'
